...
-- NOTE: Additional vim options here @@7749
...
-- NOTE: @@7749 Custom Keymaps
-- NOTE: Lazy git keymap @@7749
vim.keymap.set('n', '<leader>gg', '<CMD>LazyGit<CR>', { desc = 'Open Lazy Git' })

-- NOTE: Use <S-h,l> to move between buffers
vim.keymap.set('n', '<S-h>', '<CMD>bprev<CR>', { desc = 'Move to left buffer' })
vim.keymap.set('n', '<S-l>', '<CMD>bnext<CR>', { desc = 'Move to right buffer' })

-- NOTE: Buffers
--
vim.keymap.set('n', '<leader>bb', '<CMD>b#<CR>', { desc = '[B]uffer Alternate' })

-- NOTE: Use <C-H,K> to move 10 lines down / up
